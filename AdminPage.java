...
public class AdminPage extends JFrame {
    ...
    public AdminPage(String name) {
        ...
        manageSlotsBtn.setFont(new Font("Arial", Font.BOLD, 14));
        manageSlotsBtn.setBackground(Color.CYAN);
        manageSlotsBtn.setForeground(Color.BLACK);

        // Open the Manage Slots Page
        manageSlotsBtn.addActionListener(e -> new ManageSlotsPages());

        buttonPanel.add(manageSlotsBtn);
